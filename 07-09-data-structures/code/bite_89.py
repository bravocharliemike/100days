...
def get_every_nth_state(states=states, n=10):
    ...
    index_to_get = n
    while True:
        result.append(states[index_to_get - 1])
        index_to_get += n
        if index_to_get > len(states):
            break
    return result

# Testing the function get_every_nth_state()
# expected = ['Massachusetts', 'Missouri', 'Hawaii', 'Vermont', 'Delaware']
# test = get_every_nth_state()
# print(test)
# Testing the call get_every_nth_state(n=20)
# expected = ['Missouri', 'Vermont']
# test = get_every_nth_state(n=20)
# print(test)
...
# Testing the function get_state_abbrev()
# test1 = get_state_abbrev('Illinois')    # It should print 'IL'
#test2 = get_state_abbrev('North Dakota')    # It should print 'ND'
#test3 = get_state_abbrev('bogus')       # It should print NOT_FOUND
#print(test1)
#print(test2)
#print(test3)
